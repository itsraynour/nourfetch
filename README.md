...
- **30+ Built-in ASCII Logos**:
  ...
  - Comprehensive Linux distributions: `arch`, `ubuntu`, `fedora`, `debian`, `nixos`, `alpine`, `pop_os`, `manjaro`, `gentoo`, `kali`, `void`, `opensuse`, `artix`, `endeavouros`, `linuxmint`, `zorin`, `elementary`, `slackware`, `freebsd`, `redhat`, `rocky`, `garuda`, `parrot`, `tux`, `windows11`, `windows10`, `macos`, and custom `nour` badges.
...
#          "pop_os", "manjaro", "gentoo", "kali", "void", "opensuse", "artix", "endeavouros",
...
- **Linux Distros**: `arch`, `ubuntu`, `fedora`, `debian`, `nixos`, `alpine`, `pop_os`, `manjaro`, `gentoo`, `kali`, `void`, `opensuse`, `artix`, `endeavouros`, `linuxmint`, `zorin`, `elementary`, `slackware`, `redhat`, `rocky`, `garuda`, `parrot`, `tux`
- **BSD**: `freebsd`

...
- **Logos**: Added 18 new ASCII logos:
  - Official GNU collection: `gnu`, `gnu_small`, `guix`.
  - Linux distributions: `gentoo`, `kali`, `void`, `opensuse`, `artix`, `endeavouros`, `linuxmint`, `zorin`, `elementary`, `slackware`, `freebsd`, `redhat`, `rocky`, `garuda`, `parrot`.
